...
static void*ins(linked_t*, size_t, void*, size_t);
linked_t*linkedins(linked_t*me, void*item, size_t size){
	return (linked_t*)ins(me, sizeof(linked_t), item, size);
}
dinked_t*dinkedins(linked_t*me, void*item, size_t size){
	dinked_t*nod = (dinked_t*)ins(me, sizeof(dinked_t), item, size);
	if(nod!=NULL)nod->prev=me;
	return nod;
}
void*ins(linked_t*me, size_t nodsize, void*item, size_t size){
